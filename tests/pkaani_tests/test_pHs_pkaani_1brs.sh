...
pdb2pqr30 --ffout AMBER --titration-state-method propka --with-ph 5.0 1brs.pdb 1brs_propka.pqr 

ashs=$(cat 1brs_propka.pqr | grep "CA  ASH" | wc -l)
glhs=$(cat 1brs_propka.pqr | grep "CA  GLH" | wc -l)
hips=$(cat 1brs_propka.pqr | grep "CA  HIP" | wc -l)
pqr_lys=$(cat 1brs_propka.pqr | grep "CA  LYS" | wc -l)
pqr_arg=$(cat 1brs_propka.pqr | grep "CA  ARG" | wc -l)
pqr_tyr=$(cat 1brs_propka.pqr | grep "CA  TYR" | wc -l)
...
pdb2pqr30 --ffout AMBER --titration-state-method pkaani --with-ph 5.0 1brs.pdb 1brs_pkaani.pqr

ashs=$(cat 1brs_pkaani.pqr | grep "CA  ASH" | wc -l)
glhs=$(cat 1brs_pkaani.pqr | grep "CA  GLH" | wc -l)
hips=$(cat 1brs_pkaani.pqr | grep "CA  HIP" | wc -l)
pqr_lys=$(cat 1brs_pkaani.pqr | grep "CA  LYS" | wc -l)
pqr_arg=$(cat 1brs_pkaani.pqr | grep "CA  ARG" | wc -l)
pqr_tyr=$(cat 1brs_pkaani.pqr | grep "CA  TYR" | wc -l)
