...
########################################################
def get_desc_arrays(
    ani, species_coordinates, aev, actindex, aev_indx, elements, atype
):
    """
    ...
    # print('AEV,NN1(nn[:-1]), NN2(nn[:-3]),desc,feat',aev_arr.shape,nn_desc1.shape, \
    #         nn_desc2.shape,descriptors.shape,featurelist.shape)
