...
asps=$(cat hu4D5_5.pdb | grep "CA  ASP" | wc -l)
glus=$(cat hu4D5_5.pdb | grep "CA  GLU" | wc -l)
his_s=$(cat hu4D5_5.pdb | grep "CA  HIS" | wc -l)
lys=$(cat hu4D5_5.pdb | grep "CA  LYS" | wc -l)
args=$(cat hu4D5_5.pdb | grep "CA  ARG" | wc -l)
tyrs=$(cat hu4D5_5.pdb | grep "CA  TYR" | wc -l)
pdb2pqr30 --ffout AMBER --titration-state-method pkaani --with-ph 1.1 hu4D5_5.pdb hu4D5_5.pqr > pkaani_out.txt

ashs=$(cat hu4D5_5.pqr | grep "CA  ASH" | wc -l)
glhs=$(cat hu4D5_5.pqr | grep "CA  GLH" | wc -l)
hips=$(cat hu4D5_5.pqr | grep "CA  HIP" | wc -l)
pqr_lys=$(cat hu4D5_5.pqr | grep "CA  LYS" | wc -l)
pqr_arg=$(cat hu4D5_5.pqr | grep "CA  ARG" | wc -l)
pqr_tyr=$(cat hu4D5_5.pqr | grep "CA  TYR" | wc -l)
